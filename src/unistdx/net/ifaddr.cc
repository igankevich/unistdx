...
template <class Addr>
sys::bstream&
sys::operator<<(bstream& out, const ifaddr<Addr>& rhs) {
	return out << rhs._address << rhs._netmask;
}

template <class Addr>
sys::bstream&
sys::operator>>(bstream& in, ifaddr<Addr>& rhs) {
...
template sys::bstream&
sys::operator<<(bstream& out, const ifaddr<ipv4_addr>& rhs);

template sys::bstream&
sys::operator<<(bstream& out, const ifaddr<ipv6_addr>& rhs);

template sys::bstream&
sys::operator>>(bstream& in, ifaddr<ipv4_addr>& rhs);

template sys::bstream&
sys::operator>>(bstream& in, ifaddr<ipv6_addr>& rhs);
